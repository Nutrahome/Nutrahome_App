...
function AuthSignup({ navigation }) {
  ...
  const renderCell = ({index, symbol, isFocused}) => {
    ...
    <View style={{ width:'100%', backgroundColor:'#ffd500', flex: 1, alignItems: 'flex-start', justifyContent: 'flex-start'}}>
        ...
        <Text style={{ marginLeft:10, fontSize:30, fontFamily:'Comfortaa-Bold', marginBottom:20 }}>
          Sign Up
        </Text>          
        ...
        <Input
          ...
          leftIcon={
            <Icon style={{marginLeft:10}} name='person-outline' type='ionicon' size={24}/>
          }
        />
      ...
      />
        ...
        <Button 
          ...
          icon={
            <Icon style={{marginRight:10}} color='white' name='create-outline' type='ionicon' size={24}/>
          }
        />
        </View>
    </View>
